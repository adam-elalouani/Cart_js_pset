...
console.log("#2, #3, #4 and #7:")
console.log(getValues("price")(filterByPrice(300)(exampleCart)))
console.log(getValues("tags")(filterByTag("culpa")(exampleCart)))


console.log("#5 and #6:")
console.log(applyPercentDiscount(0.9)(exampleCart))
//console.log(applyDiscount(item => item.price * 0.9)(exampleCart))

console.log("#7:")
console.log(getValues("_id")(exampleCart))
